<%-- 
    Document   : FormRegistroRol
    Created on : 23-10-2010, 09:37:56 PM
    Author     : Daniel
--%>
...
<html>
    ...
    <body>
        <label class="titulo">Registro de Rol</label>
        <form name="frmRegistrarRol" method="post" action="muestrarol.do">
            <table border="0">
                <tr>
                    <td>
                        <label>*</label>
