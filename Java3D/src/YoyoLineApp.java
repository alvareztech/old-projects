/*
 *      @(#)YoyoLineApp.java 1.1 00/09/22 15:57
 *
 ...
 * written in Java 3D
 *
 * YoyoLineApp.java demonstrates using Appearance attributes
 * to display only the lines from a more complex geometry.
 */
...
public class YoyoLineApp extends Applet {
