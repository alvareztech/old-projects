/*
 *      @(#)ClockApp.java 1.1 00/09/22 14:37
 *
...
public class ClockApp extends Applet {
	...
	BranchGroup objRoot = new BranchGroup();
        ...
        // create Alpha that continuously rotates with a period of 1 minute
    ...
    } // end of ClockApp (constructor)

    //  The following allows this to be run as an application
    //  as well as an applet

    public static void main(String[] args) {
        System.out.print("ClockApp.java \n- a demonstration of using the RotationInterpolator ");
        ...
        Frame frame = new MainFrame(new ClockApp(), 256, 256);
    } // end of main (method of ClockApp)

} // end of class ClockApp
