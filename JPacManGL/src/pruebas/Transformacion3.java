...
/**
 * Transformacion3.java	3.0 6/04/2011
 */
 ...
 * @version 3.0 6/04/2011
 */
public class Transformacion3 implements GLEventListener, KeyListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame miMarco = new JFrame("Transformación 3");
        ...
        miCanvas.addGLEventListener(new Transformacion3());
