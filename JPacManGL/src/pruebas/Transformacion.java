...
/**
 * Transformacion.java	1.0 6/04/2011
 */
 ...
 */
public class Transformacion implements GLEventListener, KeyListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame miMarco = new JFrame("Transformación");
        ...
        miCanvas.addGLEventListener(new Transformacion());
